...
def addStitching(path, n, offset, diameter, document): 
    ...
    #for p3 in points:
    #NOTE: Need to figure out the 4 bezier points for slopeatt, t=0
    #   Parse Path?
        #drawCircle(p3, diameter/2, document)
        #slopes = bezierslopeatt(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)),0)
        #pslope = perpendicularSlope(slopes)
        #newTarget = computePointAlongLine(pSlope, p3, offset)
...
class Length(inkex.Effect):
    def __init__(self):
        ...
        self.OptionParser.add_option("-p", "--pointsS",
                        action="store", type="int", 
                        dest="pointsS", default=20,
                        help="How Many points of connection are present(stitching)")
        
        self.OptionParser.add_option("-o", "--offsetS",
                        action="store", type="float", 
                        dest="offsetS", default=5,
                        help="Offset")
